    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <header class="header-area clearfix">
            ...
            <div class="amado-btn-group mt-30 mb-100">
                    ...
                    ?>
                    <a href="carrito.php" class="btn amado-btn active"><img src="img/core-img/cart.png" alt=""> Carrito <span>(<?php echo $total_articulos; ?>)</span></a>
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="cart-summary">
                                ...
                                <div class="cart-btn mt-100">
                                    <a href="checkout.php" class="btn amado-btn active w-100""><i class="fa fa-credit-card" aria-hidden="true"></i> Pagar</a>
                                </div>
                           
                 
                            <div class="cart-btn mt-100">
                                        <a href="index.php" class="btn amado-btn active w-100""> <i class="fa fa-shopping-cart" aria-hidden="true"></i>  Seguir comprando</a>
                            </div>
                        </div>                        
                    </div>                
                </div>
